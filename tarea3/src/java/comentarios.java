...
try{
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Los comentarios son:</title>");            
            out.println("</head>");
            out.println("<body>");

        String Nombre = request.getParameter("textName");
        String Email = request.getParameter("textMail");
        String Comentario = request.getParameter("txtComment");

        String resultado = request.getParameter(Nombre);
        String resultado2 = request.getParameter(Email);
        String resultado3 = request.getParameter(Comentario);

out.println(" "+(Nombre)+" "+"("+(Email)+")"+" dice:");
out.println("<br><br>");
